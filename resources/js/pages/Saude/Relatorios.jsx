  ...
  return (
    <AppLayout title="Relatórios de Saúde">
      <div className="space-y-6">
        <form onSubmit={(e) => { e.preventDefault(); router.get('/saude/relatorios', form.data) }} className="flex gap-3 rounded-xl border border-zinc-200 bg-gradient-to-t from-primary/5 to-card p-6 shadow-xs">
