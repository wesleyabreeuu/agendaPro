  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-gradient-to-t from-primary/5 to-card p-5 shadow-xs">
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Button type="button" onClick={() => onEdit(habit)} variant="outline" size="icon-lg" className="rounded-xl border-zinc-200 bg-gradient-to-t from-primary/5 to-card text-zinc-700 hover:bg-zinc-50">
  ...
  return (
    <AppLayout title="Habitos">
      <div className="space-y-6">
        ...
        <div className="overflow-hidden rounded-xl border border-zinc-200 bg-gradient-to-t from-primary/5 to-card shadow-xs">
