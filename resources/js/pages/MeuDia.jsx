            ...
            <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
              ...
              <div className="space-y-3 xl:min-w-[560px]">
                <div className="flex flex-col items-start gap-2 xl:items-end">
                  <Button type="button" onClick={() => router.visit('/meu-dia?visao=dia')} variant="outline" className="h-11 w-auto rounded-lg border-zinc-200 bg-white px-4 text-sm text-zinc-700 shadow-xs hover:bg-zinc-50">
