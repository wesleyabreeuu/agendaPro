        ...
        <div className="grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
          ...
          <Panel title="Atalhos rápidos" subtitle="Ações úteis para ajustar seu sistema sem perder ritmo." isDark={isDark}>
            <div className="grid gap-4 md:grid-cols-2">
              <Link href="/rotinas/minhas" className={`rounded-xl border p-5 shadow-xs transition ${isDark ? 'border-zinc-700 bg-zinc-950 hover:bg-zinc-900' : 'border-zinc-200 bg-white hover:bg-zinc-50'}`}>
              ...
              <Link href="/rotinas/criar" className={`rounded-xl border p-5 shadow-xs transition ${isDark ? 'border-zinc-700 bg-zinc-950 hover:bg-zinc-900' : 'border-zinc-200 bg-white hover:bg-zinc-50'}`}>
              ...
              <Link href="/rotinas/historico" className={`rounded-xl border p-5 shadow-xs transition ${isDark ? 'border-zinc-700 bg-zinc-950 hover:bg-zinc-900' : 'border-zinc-200 bg-white hover:bg-zinc-50'}`}>
              ...
              <Link href="/rotinas/templates" className={`rounded-xl border p-5 shadow-xs transition ${isDark ? 'border-zinc-700 bg-zinc-950 hover:bg-zinc-900' : 'border-zinc-200 bg-white hover:bg-zinc-50'}`}>
