  ...
  return (
    <>
      ...
      <div className="flex min-h-svh w-full items-center justify-center bg-[radial-gradient(circle_at_top,#fef3c7_0%,#fff8ee_22%,#f5f5f4_62%,#e7e5e4_100%)] px-4 py-8 sm:px-6 lg:px-8">
        <Card className="w-full max-w-5xl overflow-hidden rounded-xl border border-white/70 bg-white/90 shadow-[0_30px_100px_rgba(24,24,27,0.18)] backdrop-blur">
                ...
                <form onSubmit={submit} className="space-y-6">
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row">
                    <Button
                      type="submit"
                      disabled={processing}
                      className="h-12 rounded-lg px-6 text-sm font-semibold shadow-lg shadow-zinc-950/15 sm:w-auto"
                    >
                    ...
                    <Button
                      ...
                      className="h-12 rounded-lg px-6 text-sm font-semibold text-zinc-700 sm:w-auto"
                    >
                      Voltar
                    </Button>
                  </div>
