    ...
    <AppLayout title="Calendário" chrome="dashboard">
      <div className="grid gap-6 xl:grid-cols-[320px_minmax(0,1fr)]">
        ...
        {!loading && eventos.length === 0 ? (
          <div className={`rounded-xl border border-dashed p-10 text-center text-sm shadow-xs ${isDark ? 'border-zinc-700 bg-zinc-900 text-zinc-400' : 'border-zinc-300 bg-white text-zinc-500'}`}>
