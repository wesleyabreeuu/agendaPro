  ...
  return (
    <div className="rounded-3xl border border-blue-200 bg-blue-50/60 p-5 shadow-sm">
      <div className="flex items-start justify-between gap-4">
        ...
        <button type="button" onClick={onClose} className="rounded-full border border-zinc-200 bg-white px-3 py-1 text-sm text-zinc-600">
          Fechar
        </button>
      </div>
      ...
      <div className="mt-5 grid gap-4 lg:grid-cols-[minmax(0,1fr)_180px_auto]">
        ...
        <button
          ...
          onClick={() => {
            onSave(compromisso.id, Number(usuarioId), permissao)
            setUsuarioId('')
